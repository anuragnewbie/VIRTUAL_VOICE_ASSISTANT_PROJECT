...
def get_audio():
    ...
    with sr.Microphone() as source:
        ...
        try:
            query = c.recognize_google(a, language='en-in').lower()
            print(query)
        except ImportError:
...
def hour():
    ...
    speak('I am Cassandra. How can i help you.')
...
def factorial(res):
    ...
    while res > 0:
        fact = fact * res
        res = res - 1
    speak("The calculated factorial result is" + str(fact))
...
# end words
            ...
            speak("Okay Bye Mate. Will be waiting for ur next call.")
            exit()

        else:
            speak("Sorry Mate! I didn't get you. Could you please repeat again ?")
